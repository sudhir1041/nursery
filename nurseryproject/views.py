...
def dashboard_view(request):
    ...
    context = {
        ...
        # 'woo_products': 0, # Placeholder for future product counts
        ...
        # 'shopify_products': 0, # Placeholder for future product counts
...
def all_orders_view(request):
    ...
    # Only fetch data if page number is provided or filters are active
    if page_number or active_filter:
        ...
        # Return empty page if no page number and no filters
        orders_page = []
